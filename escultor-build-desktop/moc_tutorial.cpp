...
static const char qt_meta_stringdata_tutorial[] = {
    "tutorial\0"
};

const QMetaObject tutorial::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_tutorial,
      qt_meta_data_tutorial, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &tutorial::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_tutorial))
